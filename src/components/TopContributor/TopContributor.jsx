...
const TopContributor = () => {
  return (
    <div class=" mb-20">
      ...
      <p class="mt-3 text-lg text-[var(--text-secondary)]">
        Meet the amazing people who make our community thrive.
      </p>
      <div class="mt-10">
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 overflow-x-auto pb-8">
          <div class="w-full text-center bg-secondary/20 rounded-lg p-6">
